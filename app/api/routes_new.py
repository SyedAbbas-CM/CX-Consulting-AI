...
async def delete_conversation(
    ...
    try:
        ...
        return JSONResponse(content={"status": "success", "message": f"Conversation {conversation_id} deleted"})
    except HTTPException:
        raise
    except Exception as e:
...
async def delete_project(
    ...
    try:
        ...
        return JSONResponse(content={"status": "success", "message": f"Project {project_id} deleted"})
    except HTTPException:
        raise
    except Exception as e:
...
async def list_project_documents(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error listing project documents: {str(e)}")
