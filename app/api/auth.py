...
from app.api.models import UserCreate, UserLogin, User, Token, UserUpdateRequest, UsersResponse
...
async def update_me(user_data: UserUpdateRequest, current_user: dict = Depends(get_current_user)):
    """
    Update current user.
