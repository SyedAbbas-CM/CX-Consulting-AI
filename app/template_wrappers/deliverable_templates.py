...
class DeliverableTemplates:
    ...
    def _load_templates(self):
        ...
        self.templates["cx_maturity_assessment"] = (
            self._create_cx_maturity_assessment_template()
        )
        self.templates["competitive_analysis"] = (
        ...
        # Client Proposals
        self.templates["consulting_proposal"] = (
            self._create_consulting_proposal_template()
        )
        self.templates["project_scope"] = self._create_project_scope_template()
        self.templates["approach_methodology"] = (
            self._create_approach_methodology_template()
        )
        ...
        self.templates["executive_presentation"] = (
            self._create_executive_presentation_template()
        )
